...
private func podPlistVersion() -> String? {
    guard
        let path = Bundle(identifier: "com.kasketis.netfox-iOS")?.infoDictionary?[
...
open class NFX: NSObject {
    ...
    // MARK: - Properties
        ...
        var nfxMenuItem: NSMenuItem = NSMenuItem(
            title: "netfox", action: #selector(NFX.show),
    ...
    extension NFX {
        ...
        fileprivate func showNFX(on rootViewController: UIViewController?) {
            let navigationController = UINavigationController(
                rootViewController: NFXListController_iOS())
            navigationController.navigationBar.isTranslucent = false
            navigationController.navigationBar.tintColor = UIColor.NFXOrangeColor()
            navigationController.navigationBar.barTintColor = UIColor.white
            navigationController.navigationBar.titleTextAttributes = [
                .foregroundColor: UIColor.NFXBlackColor()
            ]
        ...
        fileprivate func hideNFXFollowingPlatform(_ completion: (() -> Void)?) {
            navigationViewController?.presentingViewController?.dismiss(
